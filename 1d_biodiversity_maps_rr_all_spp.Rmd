...
map_rast_file <- file.path(dir_output, 'mean_rr_risk_raster_all.tif')
...
if(!file.exists(map_rast_file) | reload == TRUE) {
  ...
  ### mean_rast <- raster(file.path(dir_output, 'mean_rr_risk_raster_all.tif'))
...
map_rast_file <- file.path(dir_output, 'var_rr_risk_raster_all.tif')
...
map_rast_file <- file.path(dir_output, 'sr_rr_risk_raster_all.tif')
...
map_rast_file <- file.path(dir_output, 'sr_rr_threat_raster_all.tif')
...
if(!file.exists(map_rast_file) | reload == TRUE) {
  ...
  writeRaster(n_threat_rast, map_rast_file,
              overwrite = TRUE)
  ### n_threat_rast <- raster(file.path(dir_output, 'sr_rr_threat_raster_all.tif'))
  ...
  writeRaster(pct_threat_rast, file.path(dir_output, 'sr_rr_pct_threat_raster_all.tif'),
              overwrite = TRUE)
  ### n_threat_rast <- raster(file.path(dir_output, 'sr_rr_pct_threat_raster_all.tif'))
...
map_rast_file <- file.path(dir_output, 'trend_rr_raster_all.tif')
...
map_rast_file <- file.path(dir_output, 'sr_rr_trend_raster_all.tif')
