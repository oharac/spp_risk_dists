...
no_take_df <- bind_rows(global_no_take, global_no_take_recent, rgn_no_take) %>%
...
no_take_rr_df <- bind_rows(global_no_take_rr, global_no_take_rr_recent, rgn_no_take_rr) %>%
  mutate(lbl = forcats::fct_inorder(lbl))
# no_take_df$lbl %>% levels()
