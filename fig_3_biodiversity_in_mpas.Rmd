...
var_rast    <- raster(file.path(dir_git, 'output', 'var_risk_raster.tif'))
...
trend_rast    <- raster(file.path(dir_git, 'output', 'trend_raster.tif'))
...
sr_rr_rast        <- raster(file.path(dir_git, 'output', 'sr_rr_risk_raster.tif'))
sr_rr_threat_rast <- raster(file.path(dir_git, 'output', 'sr_rr_threat_raster.tif'))
trend_rr_rast     <- raster(file.path(dir_git, 'output', 'trend_rr_raster.tif'))
