...
cell_id_rast    <- raster(file.path(dir_git, '_spatial', 'cell_id_rast.tif'))
mean_rast       <- raster(file.path(dir_git, '_output', 
                     'mean_risk_raster_comp.tif'))
mean_rr_rast    <- raster(file.path(dir_git, '_output', 
                     'mean_rr_risk_raster_comp.tif'))
pct_th_rast     <- raster(file.path(dir_git, '_output', 
                     'pct_threat_raster_comp.tif'))
pct_th_rr_rast  <- raster(file.path(dir_git, '_output', 
...
habs_lookup <- read_csv(file.path(dir_git, '_setup/raw', 
...
write_csv(no_take_means, file.path(dir_git, '_setup/int/mpa_mean_risks_by_hab.csv'))
...
### print map
library(sf)
land_poly <- read_sf(file.path(dir_git, '_spatial/ne_10m_land/ne_10m_land.shp')) %>%
