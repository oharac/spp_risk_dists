...
write_csv(maps_from_iucn, file.path(dir_git, 'data_setup/int/map_check',
...
Focus on the non-duplicated shapes from `data_setup/int/maps_direct_from_iucn.csv`.

``` {r gather all ids and check bounds}

reload <- FALSE

maps_from_iucn <- read_csv(file.path(dir_git, 'data_setup/int/map_check',
                                     'maps_direct_from_iucn.csv'))

bounds_check_file <- file.path(dir_git, 'data_setup/int/map_check', 
                               'spp_bounds.csv')
...
``` {r generate map list from dbfs, eval = FALSE}
...
write_csv(marine_map_info, 
          file.path(dir_git, 'data/map_check', 'marine_spp_processed.csv'))
```
...
``` {r gather ids and read into a single shapefile, eval = FALSE}
