...
rgn_spp_lme <- read_csv(file.path(dir_git, 
                                   sprintf('data/iucn/iucn_risk_rgn_current_%s.csv', 
                                           api_version))) %>%
  left_join(rgn_to_lme_df, by = 'iucn_rgn')

rgn_spp_global <- read_csv(file.path(dir_git, 
                                   sprintf('data/iucn/iucn_risk_current_%s.csv', 
                                           api_version))) %>%
...
write_csv(clean_conflicts, file.path(dir_git, sprintf('data/iucn/iucn_rgn_to_lme_%s.csv', api_version)))
