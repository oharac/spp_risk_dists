---
title: 'Aggregate IUCN spp ranges, range-rarity weighted - Gall Peters projection'
...
# ocean_area_rast <- raster(file.path(dir_git, 'spatial/ocean_area_rast_gp.tif'))
...
for(taxon in taxa) {
  ...
  taxon_risk_sum_file <- file.path(dir_o_anx, 'taxa_summaries',
                                   sprintf('%s_cell_sum_rrweight_%s_gp.csv', 
