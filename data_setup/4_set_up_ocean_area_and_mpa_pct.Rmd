...
* note that area calculations for very northward cells may disagree due to weird geometry; replace only cells below 84°N (all above that should be pure ocean).  Compare value in ocean-only cells at various latitudes though to understand approximation error - approaching equator should be very close.
...
### Aggregate ocean area back to 0.10° raster
...
if(!file.exists(tenthdeg_ocean_area_file)) {
  ...
  ### above 84°N, set ocean area proportion to 1; below 84°S, set to 0.
