...
map_plot_file <- file.path(dir_git, 'ms_figures/fig1_map_mean_risk.png')
...
![](ms_figures/fig1_map_mean_risk.png)
![](ms_figures/fig_SI_map_mean_risk_ne_pac.png)
![](ms_figures/fig_SI_map_mean_risk_med.png)
![](ms_figures/fig_SI_map_mean_risk_mid_atl.png)
![](ms_figures/fig_SI_map_mean_risk_se_asia.png)

``` {r var_risk_raster}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_var_risk.png')
...
![](ms_figures/fig_SI_map_var_risk.png)

``` {r n_spp_risk}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_n_risk.png')
...
![](ms_figures/fig_SI_map_n_risk.png)

``` {r n_spp_threatened}

map_plot_file <- file.path(dir_git, 'ms_figures/fig2_map_pct_threatened.png')
...
```
![](ms_figures/fig2_map_pct_threatened.png)


``` {r trend}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_mean_trend.png')
...
![](ms_figures/fig_SI_map_mean_trend.png)

``` {r n_trend}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_n_trend.png')
...
![](ms_figures/fig_SI_map_n_trend.png)
