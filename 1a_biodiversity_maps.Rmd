...
map_rast_file <- file.path(dir_git, 'output', 'mean_risk_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'var_risk_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'n_spp_risk_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'n_threat_raster.tif')
...
if(!file.exists(map_rast_file) | reload == TRUE) {
  ...
  writeRaster(pct_threat_rast, file.path(dir_git, 'output', 'pct_threat_raster.tif'),
              overwrite = TRUE)
  ### n_threat_rast <- raster(file.path(dir_git, 'output', 'n_threat_raster.tif'))
...
map_rast_file <- file.path(dir_git, 'output', 'trend_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'n_trend_raster.tif')
