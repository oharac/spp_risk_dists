...
cell_summary_file <- file.path(dir_o_anx, 'cell_summary_unweighted.csv')
reload <- FALSE
...
map_plot_file <- file.path(dir_git, 'figs/fig1_map_mean_risk.png')
...
![](figs/fig1_map_mean_risk.png)
![](figs/fig1_map_mean_risk_ne_pac.png)
![](figs/fig1_map_mean_risk_med.png)
![](figs/fig1_map_mean_risk_mid_atl.png)
![](figs/fig1_map_mean_risk_se_asia.png)

``` {r var_risk_raster}

map_plot_file <- file.path(dir_git, 'figs/fig1_map_var_risk.png')
...
![](figs/fig1_map_var_risk.png)

``` {r n_spp_risk}

map_plot_file <- file.path(dir_git, 'figs/fig_SI_map_n_risk.png')
...
if(!file.exists(map_plot_file) | reload == TRUE) {
  ...
  x <- ggplot(n_spp_df) +
    ...
    geom_sf(data = land_poly, aes(geometry = geometry), fill = 'grey96', color = 'grey40', size = .10) +
    ggtheme_map() +
    scale_fill_gradientn(colors = c('lightblue', 'blue1', 'blue2', 'blue3', 'blue4', 'purple4'),
...
![](figs/fig_SI_map_n_risk.png)

``` {r n_spp_threatened}

map_plot_file <- file.path(dir_git, 'figs/fig2_map_pct_threatened.png')
...
if(!file.exists(map_plot_file) | reload == TRUE) {
  ...
  writeRaster(pct_threat_rast, file.path(dir_git, 'output', 'pct_threat_raster_010deg.tif'),
              overwrite = TRUE)
  ### n_threat_rast <- raster(file.path(dir_git, 'output', 'n_threat_raster_010deg.tif'))
...
```
![](figs/fig2_map_pct_threatened.png)


``` {r trend}

map_plot_file <- file.path(dir_git, 'figs/fig_SI_map_mean_trend.png')
...
![](figs/fig_SI_map_mean_trend.png)

``` {r n_trend}

map_plot_file <- file.path(dir_git, 'figs/fig_SI_map_n_trend.png')
