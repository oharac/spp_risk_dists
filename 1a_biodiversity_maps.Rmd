...
![](figs/fig_SI_map_mean_risk_ne_pac.png)
![](figs/fig_SI_map_mean_risk_med.png)
![](figs/fig_SI_map_mean_risk_mid_atl.png)
![](figs/fig_SI_map_mean_risk_se_asia.png)

``` {r var_risk_raster}

map_plot_file <- file.path(dir_git, 'figs/fig_SI_map_var_risk.png')
