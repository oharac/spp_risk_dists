...
map_rast_file <- file.path(dir_git, 'output', 'mean_risk_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'var_risk_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'n_spp_risk_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'n_threat_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'trend_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'n_trend_raster_gp.tif')
