...
# var_rast      <- raster(file.path(dir_git, 'output', 'var_rr_risk_raster_010deg.tif'))
n_spp_rast    <- raster(file.path(dir_git, 'output', 'sr_rr_risk_raster_010deg.tif'))
n_threat_rast <- raster(file.path(dir_git, 'output', 'sr_rr_threat_raster_010deg.tif'))
trend_rast    <- raster(file.path(dir_git, 'output', 'trend_rr_raster_010deg.tif'))
eez_rast      <- raster(file.path(dir_git, 'spatial', 'eez_rast_010_wgs84.tif'))
mpa_df        <- read_csv(file.path(dir_git, 'spatial', 'wdpa_mpa_area_010_wgs84.csv'))
