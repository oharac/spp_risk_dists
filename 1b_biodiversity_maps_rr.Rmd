...
map_plot_file <- file.path(dir_git, 'ms_figures/fig1_map_mean_risk_rr.png')
...
![](ms_figures/fig1_map_mean_risk_rr.png)
![](ms_figures/fig_SI_map_mean_risk_ne_pac_rr.png)
![](ms_figures/fig_SI_map_mean_risk_med_rr.png)
![](ms_figures/fig_SI_map_mean_risk_mid_atl_rr.png)
![](ms_figures/fig_SI_map_mean_risk_se_asia_rr.png)

``` {r var_risk_raster, eval = TRUE}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_var_risk_rr.png')
...
![](ms_figures/fig_SI_map_var_risk_rr.png)

``` {r n_spp_risk}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_sr_risk_rr.png')
...
![](ms_figures/fig_SI_map_sr_risk_rr.png)

``` {r n_spp_threatened}

map_plot_file <- file.path(dir_git, 'ms_figures/fig2_map_pct_threatened_rr.png')
...
![](ms_figures/fig2_map_pct_threatened_rr.png)

``` {r trend}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_mean_trend_rr.png')
...
![](ms_figures/fig_SI_map_mean_trend_rr.png)

``` {r n_trend}

map_plot_file <- file.path(dir_git, 'ms_figures/fig_SI_map_sr_trend_rr.png')
...
![](ms_figures/fig_SI_map_sr_trend_rr.png)
