...
map_rast_file <- file.path(dir_git, 'output', 'mean_rr_risk_raster.tif')
...
if(!file.exists(map_rast_file) | reload == TRUE) {
  ...
  ### mean_rast <- raster(file.path(dir_git, 'output', 'mean_rr_risk_raster.tif'))
...
map_rast_file <- file.path(dir_git, 'output', 'var_rr_risk_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'sr_rr_risk_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'sr_rr_threat_raster.tif')
...
if(!file.exists(map_rast_file) | reload == TRUE) {
  ...
  writeRaster(n_threat_rast, map_rast_file,
              overwrite = TRUE)
  ### n_threat_rast <- raster(file.path(dir_git, 'output', 'sr_rr_threat_raster.tif'))
  ...
  writeRaster(pct_threat_rast, file.path(dir_git, 'output', 'sr_rr_pct_threat_raster.tif'),
              overwrite = TRUE)
  ### n_threat_rast <- raster(file.path(dir_git, 'output', 'sr_rr_pct_threat_raster.tif'))
...
map_rast_file <- file.path(dir_git, 'output', 'trend_rr_raster.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'sr_rr_trend_raster.tif')
