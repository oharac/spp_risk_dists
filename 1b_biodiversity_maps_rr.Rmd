...
map_rast_file <- file.path(dir_git, 'output', 'mean_rr_risk_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'var_rr_risk_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'sr_rr_risk_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'sr_rr_threat_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'trend_rr_raster_gp.tif')
...
map_rast_file <- file.path(dir_git, 'output', 'sr_rr_trend_raster_gp.tif')
