...
![](figs/fig_SI_map_mean_risk_ne_pac_rr.png)
![](figs/fig_SI_map_mean_risk_med_rr.png)
![](figs/fig_SI_map_mean_risk_mid_atl_rr.png)
![](figs/fig_SI_map_mean_risk_se_asia_rr.png)

``` {r var_risk_raster, eval = TRUE}

map_plot_file <- file.path(dir_git, 'figs/fig_SI_map_var_risk_rr.png')
...
![](figs/fig_SI_map_var_risk_rr.png)
