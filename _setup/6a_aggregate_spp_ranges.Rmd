...
for(taxon in taxa) {
  ...
  taxon_sum_file <- file.path(dir_o_anx, 'taxa_summaries_2019',
  ...
  if(!file.exists(taxon_sum_file) | reload == TRUE) {
    ...
    taxon_cells_list <- parallel::mclapply(taxon_ids, mc.cores = 24,
        ...
        ### x <- taxon_ids[1]
        ### x <- 6336                            
        csv_file <- file.path(dir_o_anx, 'spp_rasters_2019', 
...
### exclude non-comp-assessed reptiles (turtles, crocs, and seasnakes are comp)
taxa <- taxa[taxa != 'REPTILES']
