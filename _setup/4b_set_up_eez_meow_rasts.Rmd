...
eez_rast_file <- file.path(dir_git, '_spatial', 'eez_rast.tif')
eez_shp_file  <- file.path(dir_M, 'git-annex/globalprep/spatial/v2017/regions_2017_update.shp')

area_rast <- raster(file.path(dir_git, '_spatial', 'ocean_area_rast.tif'))
...
meow_rast_file <- file.path(dir_git, '_spatial', 'meow_rast.tif')
...
bathy_rast_file <- file.path(dir_git, '_spatial', 'bathy_rast.tif')
...
if(!file.exists(bathy_rast_file)) {
  ...
  writeRaster(rast_neritic, file.path(dir_git, '_spatial', 'bathy_rast_neritic.tif'),
              overwrite = TRUE)
  writeRaster(rast_shallow, file.path(dir_git, '_spatial', 'bathy_rast_shallow.tif'),
              overwrite = TRUE)
