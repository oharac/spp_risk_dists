...
rgn_spp_info_file <- file.path(dir_data, sprintf('iucn_risk_rgn_current_%s.csv', api_version))
...
if(!file.exists(rgn_spp_info_file)) {
  ...
  spp_rgn_marine <- read_csv(file.path(dir_data,
...
global_marine_spp_risk <- read_csv(file.path(dir_data, sprintf('iucn_risk_current_%s.csv', api_version)))
