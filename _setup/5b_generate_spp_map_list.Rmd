...
marine_spp <- read_csv(file.path(dir_git, 
                                 sprintf('data/spp_marine_from_api_%s.csv', 
                                         api_version)),
                       col_types = 'dcc')
...
write_csv(subpops_match, 
          file.path(dir_git, sprintf('setup/int/subpops_match_api_to_shp_%s.csv', 
                                     api_version)))
...
comp_file <- file.path(dir_git, 'data', 
...
marine_map_info <- read_csv(file.path(dir_git, 'data',
  sprintf('spp_marine_maps_%s.csv', api_version))) %>%
  select(-presence) %>%
  distinct()
...
cat_info <- read_csv(file.path(dir_git, 'data', 
...
write_csv(all_sum, file.path(dir_git, 'output', 
                             'spp_included_summary.csv'))
write_csv(all_in_the_fam, file.path(dir_git, 'output', 
