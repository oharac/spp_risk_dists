...
nspp_un_rast <- raster(file.path(dir_git, '_output', 'n_spp_risk_raster_comp.tif'))
nspp_rr_rast <- raster(file.path(dir_git, '_output', 'sr_rr_risk_raster_comp.tif'))
var_un_rast  <- raster(file.path(dir_git, '_output', 'var_risk_raster_comp.tif'))
var_rr_rast  <- raster(file.path(dir_git, '_output', 'var_rr_risk_raster_comp.tif'))
