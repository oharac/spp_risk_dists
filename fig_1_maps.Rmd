...
risk_un_rast   <- raster(file.path(dir_output, 'mean_risk_raster_comp.tif'))
risk_rr_rast   <- raster(file.path(dir_output, 'mean_rr_risk_raster_comp.tif'))
threat_un_rast <- raster(file.path(dir_output, 'pct_threat_raster_comp.tif'))
threat_rr_rast <- raster(file.path(dir_output, 'sr_rr_pct_threat_raster_comp.tif'))
n_spp_rast     <- raster(file.path(dir_output, 'n_spp_risk_raster_comp.tif'))
n_rr_rast      <- raster(file.path(dir_output, 'sr_rr_risk_raster_comp.tif'))
...
# fig1_path <- file.path(dir_git, 'ms_figures/fig1_comp_assessed.tiff')
...
risk_un_rast    <- raster(file.path(dir_output, 
                                    'mean_risk_raster_all.tif'))
risk_rr_rast    <- raster(file.path(dir_output, 
                                    'mean_rr_risk_raster_all.tif'))
threat_un_rast  <- raster(file.path(dir_output, 
                                    'pct_threat_raster_all.tif'))
threat_rr_rast  <- raster(file.path(dir_output, 
                                    'sr_rr_pct_threat_raster_all.tif'))
n_spp_rast <- raster(file.path(dir_output, 
                               'n_spp_risk_raster_all.tif'))
n_rr_rast  <- raster(file.path(dir_output, 
